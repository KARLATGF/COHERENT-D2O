    ...
    switch( matName )
	{
		...
		case PMMA:
			if(!matPMMA){
                ...
                SetOpticalProperties(matPMMA, indexPMMA, "opticalData/AcrylicAbsLength_formatted.dat"); //Using new Attenuation Length
...
//                SetUniformOpticalProperties(matH2O, indexH2O, absH2O);
                ...
                SetOpticalProperties(matH2O, indexH2O, "opticalData/pureWaterAbsLength_formatted.dat");
...
//                SetUniformOpticalProperties(matD2O, indexD2O, absD2O);
                ...
                SetOpticalProperties(matD2O, indexD2O, "opticalData/pureWaterAbsLength_formatted.dat");
...
void G4d2oMaterialsDefinition::SetOpticalProperties(G4Material *theMat, G4double theIndex, G4String absLengthFile){
