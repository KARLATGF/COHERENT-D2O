...
G4int G4d2oDetector::InitializeQEArray() {
    ...
    for(size_t ipoint = 0; ipoint<qe_bialkali_xnm.size(); ipoint++ ){
       ...
       fPMTQE->SetPoint(ipoint,qe_bialkali_xgev[ipoint]*1e9,(1.033*1.01/0.8368)*qe_bialkali_y[ipoint]); //Scaled to match DATA and MC! 02/2023, last edit: 09/2023 for summer run.
